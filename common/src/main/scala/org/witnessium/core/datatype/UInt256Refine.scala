...
object UInt256Refine {
  ...
  object UInt256RefineOps {
    ...
    implicit val refineBytes: UInt256RefineOps[ByteVector] = new UInt256RefineOps[ByteVector] {
      @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
      def from(value: ByteVector): Either[String, UInt256Bytes] = Either.cond(value.size === 32,
    ...
    implicit val refineBigInt: UInt256RefineOps[BigInt] = new UInt256RefineOps[BigInt] {
      @SuppressWarnings(Array("org.wartremover.warts.AsInstanceOf"))
      def from(value: BigInt): Either[String, UInt256BigInt] = Either.cond(value >= 0 && value.bitLength <= 256,
